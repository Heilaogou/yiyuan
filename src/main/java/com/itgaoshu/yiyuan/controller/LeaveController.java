...
public class LeaveController {
    ...
    public Object selRegisters(Integer page, Integer limit,String userNames){
        ...
        List<Register> list = leaveService.selRegisters(register);
    ...
    public Object updLeave(Register register){
        int i = leaveService.updRstate(register);
        if(i==1){
            int j = leaveService.updBstate(register);
            if(j==1){
                return "出院成功";
            }else{
                return "出院失败";
    ...
    public Object selYaos(Register register){
        int i = leaveService.selYaos(register);
        return i;
    }
    ...
    public Object selregis(Integer registerid){
        ...
        List<Register> registers = leaveService.selRegisters(register);
        return registers;
    }
